...
| Highgui  | OpenCV 3.0中分为 imcodecs、videoio、highgui 三部分。包含用来显示图像或者简单输入的交互函数，可以看作是一个轻量级的UI工具包。 | libopencv_imgcodecs.so<br />libopencv_videoio.so<br />libopencv_highgui.so |
